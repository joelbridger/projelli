...
- **Connector-access research (`docs/strategy/2026-06-29-connector-access-options-rightcapital-jump.md` + `…-connector-feasibility-rightcapital-jump.md`).** Research-only: every way (beyond the official API) Keepance could read the output of RightCapital and Jump, with a recommended legitimate near-automated path for each and exactly what Keepance can honestly claim. No code changed.
