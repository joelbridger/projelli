# 03 — Advisor workflow model & Jobs-to-be-Done (2026-07-10 session)

*Drafted by the workflow-analysis lane; reviewed and adopted by the lead after checking its
timestamps and tiering against the full transcripts and the skeptic lane's counteranalysis.
Where the skeptic lane adds a further discount (e.g. the task-triage coach and manager-report
ideas originated in interviewer pitches), deliverables 02/04/05 carry the reconciled
confidence levels.*
