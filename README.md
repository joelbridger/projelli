...
- **Data connectors.** Read-only connectors pull a client's files and records into the local index from OneDrive/SharePoint, Microsoft 365 and Gmail email, and the Wealthbox CRM — all shipping today. (More CRM and document sources are staged behind vendor access.)
