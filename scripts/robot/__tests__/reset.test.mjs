...
describe('RESIDUE_KEYS', () => {
  it('includes every known residue store that skewed past runs', () => {
    for (const k of ['lantern:client-maps','ai-chat-storage','lantern:matter-ui-snapshots','lantern:client-map-templates','workspace_versions']) {
  ...
  it('never strips legit config keys', () => {
    for (const keep of ['apiKey_openai','lantern:matters','lantern:settings','lantern_profession']) {
