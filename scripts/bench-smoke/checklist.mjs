...
export const CHECKLIST = [
  ...
  { id: 'wave4-whole-practice-ask', section: 'Wave 4 — Depth (Track C: hidden whole-practice Ask scope)', title: 'Ask "Whole practice" scope option is hidden; remaining scope pills still switch', liveOnly: false, run: wave4Checks.checkWholePracticeAsk },
