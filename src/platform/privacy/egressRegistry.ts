...
const operations = [
  ...
  connectorOperation({
    ...
    approvalText: 'This contacts Salesforce to complete sign-in and check the connected account.',
    dataSummary: 'The sign-in code, connection metadata, and account identity.',
    dataClasses: ['metadata', 'credential'],
  ...
  connectorOperation({
    ...
    dataSummary: 'Connection metadata and account identity.',
    dataClasses: ['metadata', 'credential'],
  ...
  connectorOperation({
    ...
    dataSummary: 'The Redtail login and basic account metadata.',
    dataClasses: ['metadata', 'credential'],
  ...
  connectorOperation({
    ...
    requiresFinalApproval: true,
    destination: { userSelectedHost: true, rejectPrivateNetwork: false },
  }),
  connectorOperation({
