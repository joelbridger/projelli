...
export const DATA_MAP_ROWS: MapRow[] = [
  ...
  },
  {
    ...
    body: 'Run a local model with Ollama and switch Lantern to Local AI only (Settings → Privacy). In that mode no AI prompt or file is sent to cloud AI. Connectors you set up, like Wealthbox or email, can still sync. Turn on Offline Mode if you want Lantern to make no internet connections at all.',
  },
  {
    icon: Mail,
    tone: 'text-emerald-700 bg-emerald-50 dark:text-emerald-300 dark:bg-emerald-950/40',
