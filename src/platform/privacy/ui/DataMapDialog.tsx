...
export const DATA_MAP_ROWS: MapRow[] = [
  ...
  },
  {
    ...
    body: 'Run a local model with Ollama and switch Keepance to Local-only mode (Settings → AI → Confidentiality mode). In that mode the prompt and your files are processed by a model on your own machine, so no AI prompt or file is ever sent to a cloud AI: not to a provider, not to Keepance. (Connectors you set up, like Wealthbox or email, still sync if you use them.)',
  },
  {
    icon: Mail,
    tone: 'text-emerald-700 bg-emerald-50 dark:text-emerald-300 dark:bg-emerald-950/40',
