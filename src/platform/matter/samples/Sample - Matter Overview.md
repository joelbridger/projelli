...
| December 4, 2025 | First HVAC failure, Roberto's first certified letter to Meridian |
...
Roberto is steady and organized. He has kept good records, which is unusual at intake. He is not looking for a quick settlement -- he wants the system fixed and is open to litigation if Meridian continues to ignore the letters. He is not behind on rent and has no intention of abandoning the space. He asks good questions and will follow instructions.
...
Try asking: "Draft a client update letter summarizing the timeline above and requesting that Roberto confirm the temperature logs are ready to produce."
