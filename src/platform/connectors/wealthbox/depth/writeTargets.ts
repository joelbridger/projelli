...
const BASIC_WORKFLOW_NOTICE =
  'This Wealthbox Basic account does not expose workflow automation here. Lantern will not guess a workflow step or claim it was started. Keep this as a reviewed manual handoff until the account and API confirm a workflow launch.';

const ASSIGNEE_CONFIRMATION_NOTICE =
  'The task is ready, but the assignee field has not been confirmed against this Wealthbox account yet. Lantern will not send an assignment until that API field is verified.';
