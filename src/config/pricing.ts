  ...
  rows: [
    {
      ...
      position: 'A different job (meeting capture and CRM sync); Lantern is the private layer for confidential drafting and analysis',
    },
    {
      product: 'eMoney / MoneyGuidePro AI (bundled)',
      price: 'bundled into the planning suite',
      position: 'A planning-tool add-on that runs in the vendor cloud; Lantern keeps client data on your machine',
    },
    {
      product: 'ChatGPT (free / Plus)',
      price: '$0 to $20/mo',
      position: 'Generic and cloud-only; with Lantern on a local model no client data leaves your machine',
    },
    {
      product: 'Microsoft 365 Copilot',
      price: '$21 to $30/mo add-on (needs base M365)',
      position: 'Lantern Solo is at or above, with advisor-specific depth and no required base subscription',
    },
  ],
} as const;
...
export const GRANDFATHER_POLICY = {
  blurb:
    'Bought the old one-time Personal, Professional, or Practice license? You keep exactly what you paid for, in good faith. Lantern 3.0 is a new, repositioned product at new pricing, and we never claw back what you already own.',
} as const;
