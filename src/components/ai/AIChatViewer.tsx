...
import { Send, Square, Download, Mic, MicOff, GripVertical, Sparkles, ChevronDown, ChevronRight, Check, X, Pencil, Brain, AlertTriangle, Briefcase, Globe, ShieldAlert } from 'lucide-react';
