 ...
 * Why this exists
 * ───────────────
 * Keepance 3.0 moves to a per-seat ANNUAL subscription (Solo / Professional /
...
/**
 * The Keepance 3.0 boundary. Any license whose purchase predates this instant
  ...
  switch (e.state) {
    ...
    case 'grandfathered':
      return {
        ...
        body: 'Your original license stays fully active. Keepance 3.0 never claws back what you already own.',
      };
    case 'offline-grace':
      return {
