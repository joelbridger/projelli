...
import { MatterSyncClient, type MatterSyncCallbacks, type WebSocketFactory, type SyncStatus } from '@/modules/firm/MatterSyncClient';
...
export class MatterDocSyncClient {
  ...
  constructor(opts: MatterDocSyncOptions) {
    ...
    const syncOpts: import('@/modules/firm/MatterSyncClient').MatterSyncOptions = {
