...
Bell Atl. Corp. v. Twombly, 550 U.S. 544 (2007)`,
  },
  {
    ...
    required: true,
    options: [
      { value: 'brief', label: 'Court brief or motion (practitioner format)' },
      { value: 'memo', label: 'Legal memorandum (practitioner format)' },
      { value: 'law_review', label: 'Law review or academic article' },
      { value: 'contract', label: 'Contract or transactional document' },
    ],
  },
  {
    id: 'jurisdiction',
  ...
  },
  {
    ...
    required: true,
    options: [
      { value: 'yes', label: 'Yes — generate a complete TOA' },
      { value: 'no', label: 'No — formatted citations only' },
    ],
  },
  {
...
*Citation formatting produced by Keepance AI. Verify every citation against the current Bluebook edition before filing. AI formatting is a starting point — do not rely on it without independent verification.*`;
