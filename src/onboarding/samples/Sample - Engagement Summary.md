...
> This is a sample so you can see what a finished engagement summary looks like in Keepance. Delete it whenever you want.

---

**Client:** Hartwell Distribution Co.
**Engagement code:** HDC-2026-03
**Engagement type:** Operating model review and fulfillment optimization
**Start date:** March 1, 2026
**Lead consultant:** Solo practice
...
- Work files in this workspace stay local. That is why Keepance is the right tool here.
...
- AI queries using the data in this workspace go directly from your machine to your API provider. No data touches Keepance's servers. Keep it that way.

---

*Prepared in Keepance. Review and edit before sharing with any client or stakeholder.*
