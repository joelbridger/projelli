...
**Status:** Merged and in `lantern-3.0`. Gated on Addepar integrator credentials - the connector code is complete but can't authenticate in production until Lantern has a partner API key from Addepar.
