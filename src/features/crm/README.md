...
**Status:** Wealthbox shipped and demo-proven (2026-06-28 Windows demo). Salesforce and Redtail code is complete — gated on `LANTERN_SALESFORCE_CLIENT_ID` and `LANTERN_REDTAIL_API_KEY` respectively.
