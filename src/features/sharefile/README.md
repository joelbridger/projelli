...
**Status:** Merged and in `lantern-3.0`. Gated on ShareFile partner/integrator credentials — the connector code is complete but requires an approved ShareFile app to authenticate in production.
