...
export function HouseholdTimeline({ household, records, freshness }: { household: TimelineHousehold; records: readonly TimelineRecord[]; freshness: CrmEngineFreshness }) {
