// Spreadsheet grid view cluster extracted from SpreadsheetViewer.tsx
// (behavior-preserving 3.0 reorg). The virtualized grid (SheetGrid), its
// rows (SheetRow), and individual cells (Cell). Pure presentational + local
// edit/resize state; every input from the parent arrives via props.
