...
function CrmShellFrame() {
  ...
  return (
    ...
    >
      <aside
        className="flex w-60 shrink-0 flex-col border-r border-slate-200 bg-white px-3 py-5"
      >
...
/**
 * The outer gate must stay free of CRM destination reads and data hooks. With
 * the flag dark, the existing CRM remains untouched and this surface is inert.
 */
export function CrmShellSurface() {
  const enabled = useFlag('crm-shell-v1');
  return enabled ? <CrmShellFrame /> : null;
}
