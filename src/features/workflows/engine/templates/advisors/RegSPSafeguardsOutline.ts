...
const interviewQuestions: InterviewStepConfig['questions'] = [
  ...
  },
  {
    ...
    type: 'textarea',
    required: true,
    placeholder: 'e.g., Orion (portfolio management), Salesforce (CRM), MoneyGuide Pro (financial planning), Microsoft 365 (email + SharePoint), Keepance (AI-assisted client workflows), Dropbox (file sharing)',
  },
  {
    id: 'dataCategories',
