...
*This checklist was generated by Advisor Prep Hero AI. Verify all items against the specific transaction documents, lender requirements, and {{jurisdiction}} closing procedures before use.*`;
