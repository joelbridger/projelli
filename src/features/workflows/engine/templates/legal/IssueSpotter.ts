...
const interviewQuestions: InterviewStepConfig['questions'] = [
  {
    ...
    description: 'A short name for this matter, used in the heading of the analysis.',
    type: 'text',
    required: true,
  ...
  {
    id: 'matterType',
    question: 'Matter type / practice area',
...
*This issue analysis was generated by Advisor Prep Hero AI and requires attorney review. It identifies issues to investigate; it is not legal advice and does not resolve the matter.*`;
