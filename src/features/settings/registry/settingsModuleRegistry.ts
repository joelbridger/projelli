...
import { bookingAvailabilitySettingsPanel } from '@/features/booking';
import { dataPortabilitySettingsPanel } from '@/features/data-portability';
import type {
