...
**Status:** Merged and in `lantern-3.0`. Gated on Box developer/partner credentials - the connector code is complete but can't authenticate in production until Lantern has an approved Box app.
