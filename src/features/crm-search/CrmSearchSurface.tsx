...
export function CrmSearchSurface() {
  ...
  const submit = async (event: FormEvent) => {
    ...
    setSelected(null);
    try {
      setHits(await searchCrmRecords(live.workspaceRoot, submittedQuery, scope || undefined));
