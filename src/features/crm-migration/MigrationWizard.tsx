...
function LiveMigrationWizard() {
  ...
  const households = live.records.filter((record) => record.kind === 'household').map((record) => ({ id: record.id, label: String(record['name'] ?? record['label'] ?? 'Imported household') }));
