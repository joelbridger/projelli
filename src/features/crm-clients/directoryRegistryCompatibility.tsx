...
export const legacyDirectoryViews: readonly DirectoryViewDescriptor[] = [
  ...
  { id: 'book', order: 20, isActive: (context) => context.view.value === 'book', mount: (context) => context.view.value === 'book' ? <BookDirectoryView onOpenClient={(id) => { context.repository.openHousehold(id); }} /> : null },
];
