  ...
  return (
    <aside className="kp-spine">
      <div className="kp-brand">
        <KeepanceMark />
        <span className="kp-brand-word">Keepance</span>
      </div>
      <div className="kp-brand-firm">{FIRM}</div>
...
/** The Keepance keep-mark from keepance.com — white keep + gradient sparkle on navy. */
function KeepanceMark() {
  return (
    <svg className="kp-brand-mark" viewBox="0 99 651 652" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>
        <linearGradient id="kpmark-g" x1="384.994" y1="476.943" x2="447.494" y2="408.443" gradientUnits="userSpaceOnUse">
