...
while true; do
  ...
  LEGION_DRIVER=$(tmux ls 2>/dev/null | grep -oE 'cc-lantern-(regression|meetverify[0-9]*|sidecar|trustreview|transfix|noticeverify|meetverify|legionwarm|qa60)' | head -1)
