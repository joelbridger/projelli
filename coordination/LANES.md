...
| cc-lantern-sidecar | Bench-infra: build+stage the speech sidecar on the Legion (brief w-sidecar-brief.md) — pulls the Meetings re-verify forward; owns the Legion | staging |
