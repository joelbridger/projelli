 ...
 *
 * Vite build target for the projelli.com/try web demo.
 *
 * Outputs to `dist-web-demo/`. Sets `__PROJELLI_DEMO__` so the demo-only
 ...
 * assets correctly when Caddy serves it under `projelli.com/try/`.
 *
...
export default mergeConfig(
  ...
  defineConfig({
    base: '/try/',
    define: {
      __PROJELLI_DEMO__: 'true',
      __PROJELLI_DESKTOP__: 'false',
      __PROJELLI_VERSION__: JSON.stringify(packageJson.version),
    },
    build: {
