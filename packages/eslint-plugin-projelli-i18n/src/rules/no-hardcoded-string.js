...
module.exports = {
  meta: {
    ...
    messages: {
      hardcoded:
        'Hardcoded user-facing string ("{{snippet}}"). Wrap in t() or <Trans>, or add `// eslint-disable-next-line projelli-i18n/no-hardcoded-string` for an intentional exception.',
    },
    schema: [],
  },
  create(context) {
