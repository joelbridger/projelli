...
Official scaffolder for new [Projelli](https://projelli.com) plugins.
...
- `package.json` (pinned to `@projelli/plugin-api` and Vite)
...
Then sideload `dist/index.js` plus `manifest.json` into your local Projelli plugins folder. See the [Getting Started guide](https://projelli.com/docs/plugins/getting-started) for the full path on each platform.
