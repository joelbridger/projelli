...
export const FEATURES: readonly ParityFeature[] = [
  ...
  live('Note search (keyword only)', 'crm-note-search', 'IMPROVE', 'search', (app) => app.durableFeature({ route: 'crm-home-nav-search', controls: ['crm-search-input', 'crm-search-result'], result: 'Parity note' })),
  ...
  live('Redtail', 'redtail-migration', 'REPLICATE', 'migration', (app) => app.durableFeature({ route: 'crm-home-nav-firm-setup', controls: ['crm-redtail-import', 'crm-migration-fidelity'], action: 'crm-redtail-import', recordKind: 'migrationReport' })),
  live('Salesforce', 'salesforce-migration', 'REPLICATE', 'migration', (app) => app.durableFeature({ route: 'crm-home-nav-firm-setup', controls: ['crm-salesforce-import', 'crm-migration-fidelity'], action: 'crm-salesforce-import', recordKind: 'migrationReport' })),
