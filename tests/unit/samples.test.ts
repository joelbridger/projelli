 ...
 *
 * Verifies the three Markdown samples under src/onboarding/samples exist on
 * disk, contain no em dashes (Projelli voice rule — see
...
const SAMPLES_DIR = resolve(__dirname, '../../src/onboarding/samples');
...
describe('onboarding samples', () => {
  ...
  it('exports exactly 3 samples from the index', async () => {
    const mod = await import('../../src/onboarding/samples/index');
