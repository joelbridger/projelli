...
const rule = require('../../../packages/eslint-plugin-projelli-i18n/src/rules/no-hardcoded-string.js');
...
ruleTester.run('no-hardcoded-string', rule, {
  valid: [
    ...
    { code: 'const C = () => <code>npm install projelli</code>;' },
  ...
  invalid: [
    ...
    {
      code: 'const C = () => <h1>Welcome to Projelli, friend</h1>;',
      errors: [{ messageId: 'hardcoded' }],
    },
  ],
});
