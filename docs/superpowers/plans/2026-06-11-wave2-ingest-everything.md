...
- **Bump `INDEX_VERSION` 8→9** (`9: VG-6e — path/source_id tokenized + path_enc encrypted at rest`); the migration re-indexes once, leaving no plaintext paths behind.
