...
> **Purpose:** This is the file I read before writing any marketing copy that mentions competitors, before answering bar association or community forum questions, and before deciding what to highlight on the homepage. It's the answer to "how is Advisor Prep Hero different from X?", the question every launch will get within the first hour.
>
...
> below ("attorneys, CPAs, consultants") is **superseded**: Advisor Prep Hero now leads for
...
**Advisor Prep Hero is the only desktop app that puts a real Markdown editor and a streaming AI chat on the same screen, where every conversation drops a real file onto your hard drive, for attorneys, CPAs, and consultants who cannot let their confidential client files live in someone else's cloud.**
...
| Tool | Local-first? | BYOK? | AI native? | File format | Pricing | Target audience | Biggest gap vs Advisor Prep Hero |
|---|---|---|---|---|---|---|---|
| **Advisor Prep Hero** | ✅ | ✅ | ✅ | Word `.docx` on disk (Markdown for utility files) | $468 / $948 / $1,548-seat per year | Financial advisors (law/tax/consulting secondary) | n/a (desktop-only) |
...
The temptation is to say "Advisor Prep Hero isn't just a note app, it's an AI workspace." Don't. That's empty. Be concrete instead. Here's the actual frame:

> **If you've ever typed client details into ChatGPT and then thought "wait, I just violated privilege / §7216 / my NDA" — that's the problem Advisor Prep Hero exists to prevent. Every conversation stays on your machine. Nothing leaves.**
...
> Honestly, stay in Notion for the team collaboration layer. Advisor Prep Hero is single-user and local-first by design. Real-time collaboration is the thing it's not trying to do. If you need more than one person editing the same document at the same time, Notion is the right answer. If you need AI-assisted drafting of confidential documents that can't leave your machine, those are complementary tools, not competitors.

### "I already have an Obsidian setup with my own AI plugins."

> If your Obsidian + plugin stack is working for you, there's no reason to switch. Advisor Prep Hero is for the professionals who want this experience without assembling it themselves — and who specifically need profession-specific workflow templates for legal, tax, or consulting work. The Personal tier is worth a 5-minute look just so you can compare, but I wouldn't tear down a working Obsidian vault to migrate.

### "I'm a developer and I just live in Cursor."

> Different tools for different jobs. Cursor for the code, Advisor Prep Hero for the client work, engagement letters, research docs. They don't compete, they complement each other.

### "ChatGPT is fine for me."

> If ChatGPT is fine for you, ChatGPT is fine for you — assuming your work doesn't touch attorney-client privilege, §7216, or a client NDA. The specific moment Advisor Prep Hero wins is when you realize you just pasted a client's tax return or legal matter details into OpenAI's servers, or when you're digging through months of ChatGPT history to find that memo you wrote in February. If neither of those has happened to you yet, you may not need Advisor Prep Hero.
...
### "Advisor Prep Hero has no multimodal / can't take images."
...
> Honest answer: not yet. v2.0 ships the cloud-sync read workflow at keepance.com/docs/mobile-access (iCloud Drive, Dropbox, Syncthing, Google Drive setup pages, plus an in-app Settings → Mobile mirror with iOS deep links). The dedicated mobile reader app is post-v2.0, blocked on Mac time + Apple Developer signup, not on Advisor Prep Hero engineering capacity. If mobile editing is your primary need, you probably want Notion or Reflect today.

---

## What we're NOT competing on (and why that's fine)

| Thing | Advisor Prep Hero's position |
|---|---|
...
| **Slickest design** | Reflect is prettier. Advisor Prep Hero is functional and fast. |
| **Biggest community** | Obsidian has 1,500+ plugins versus Advisor Prep Hero's four. We just shipped the runtime; the catalog will grow. |
| **Image generation** | ChatGPT has DALL-E and Sora. Advisor Prep Hero takes images IN, doesn't make them. |
...
|---|---|---|---|
| **Advisor Prep Hero Solo** | **$468** | **$1,404** | $468/yr per-seat annual subscription (updated 3.0; was a one-time $49) |
| **Advisor Prep Hero Professional** | **$948** | **$2,844** | $948/yr; adds the full workflow library / all profession packs |
| **Advisor Prep Hero Firm** | **$1,548/seat (min 3 = $4,644)** | **$13,932 (3 seats)** | $1,548/seat/yr, min 3 seats; shared clients, SSO, information barriers, Assured |
...
**Advisor Prep Hero Professional pays for itself in under 7 months vs the cheapest subscription competitor.**
