# Advisor Prep Hero — Windows Desktop Test Plan (drive the real app)
...
| B3 | Recent-workspaces list reopen | `recent-workspaces-toggle`, `recent-workspace-row` | ✅ | **CONFIRMED LIVE (2026-06-20)** — after a dev restart the selector showed "Recent (2)"; expanding it and clicking the Advisor Prep HeroTest row reopened the workspace (no native picker needed). |
