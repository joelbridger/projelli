...
**Effort:** S
**Reference script** — see the post-publish patch I did for v1.0.8 in the `~/.claude/projects/-home-jameson/memory/project_projelli.md` session notes; can lift the logic straight into a workflow step.
