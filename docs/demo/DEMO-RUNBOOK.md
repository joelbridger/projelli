...
**What to do:**
1. Open the app's AI settings screen.
2. Show ChatGPT is already connected — point at the little "✓ Working" checkmark.
3. Show the Local AI card says "Installed and ready" — explain in one line: *"This one lives right on this computer. Nothing about your questions ever has to leave the machine when you use it."*
