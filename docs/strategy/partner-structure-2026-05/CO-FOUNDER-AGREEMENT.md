...
- Outreach: contacting newsletters, directories, podcasts, and communities
- General co-founder input: contributing ideas, feedback, and direction on the product and business

This role can grow over time by mutual agreement between Jameson and Matthan.
...
- **First 6 months:** Matthan earns nothing yet. This is called the cliff. If either party decides to stop within the first 6 months, Matthan receives no ownership.
- **At 6 months:** Matthan earns 12.5% of his total share all at once (which is 3.125% of the total company).
- **Months 7 through 48:** The remaining ownership trickles in each month automatically, a small amount every month until the full 4 years are complete.
- **After 4 full years:** Matthan has earned his complete 25%.
...
**How sales are tracked:** Total cumulative sales are measured using the gross sale amount shown in the LemonSqueezy dashboard (the amount the customer paid, before any platform fees are deducted). Matthan has read-only access to the LemonSqueezy dashboard at all times so he can see the numbers himself.

**When Matthan gets paid:** Jameson pays Matthan his share of sales within 15 days of the end of each calendar month. For example, all sales made in June are paid out by July 15th.
...
**Second:** Both Jameson and Matthan sit down together within 30 days of hitting $25,000 to renegotiate. This conversation covers:

- Matthan's ongoing role — whether it stays focused on marketing, or expands into other areas of the business
- Whether a new revenue share makes sense at the new scale of the company
...
- **Matthan makes all day-to-day marketing decisions** without needing to ask Jameson. He is trusted to execute.
- **Jameson makes final decisions** on product direction, pricing changes, major business strategy, and any spend over $300 in a single transaction.
- If there is ever a disagreement that cannot be resolved between the two of them, both parties agree to talk it through before taking any formal action. Family comes first.

---

## 10. If Either Person Wants to Stop

**If Matthan wants to stop:**
- He gives Jameson 30 days notice.
- He keeps whatever ownership he has already earned up to that point.
- The 50% sales cut stops on his last day.
- Any unearned ownership goes back to Jameson.

**If Jameson asks Matthan to stop:**
- Jameson gives Matthan 30 days notice.
...
## 12. This Is a Binding Agreement

Both parties have read this agreement, understand it, and agree to it. Both parties also agree to have this document reviewed by a lawyer within 60 days of signing, and to update it if a lawyer identifies anything that needs to change.
...
**Jameson Samuel Daines**
Date: ________________

&nbsp;

___________________________________
**Matthan William Daines**
Date: ________________

---

*Note: Both parties should keep a signed copy of this document. Take a photo of the signed page as a backup.*
