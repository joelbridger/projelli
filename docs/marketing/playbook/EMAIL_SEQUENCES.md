...
3. If you want a peek before launch, you can already download
   ...
   https://github.com/keepance/keepance/releases/latest
...
- Product Hunt: https://www.producthunt.com/posts/keepance
...
- Getting Started: https://keepance.com/docs/getting-started
- API Keys Guide:  https://keepance.com/docs/api-keys
- FAQ:             https://keepance.com/docs/faq
...
--
keepance.com
P.S. The Getting Started doc at keepance.com/docs/getting-started
...
|---|---|---|---|
| 01 Welcome | New row in `~/keepance/sign-ups/keepance-launch-email-list-*.jsonl` | Brevo via form-handler | Wire from form-handler service after JSONL append |
