...
>
> It's $39/month (or $468/year) for the Solo plan, with a 30-day trial, no card, no account: https://keepance.com
>
...
>
> Source isn't fully open yet, but the trust model doesn't depend on trusting me: your key is in the OS keychain, the network calls go to the provider you picked, and the output is real files in your own folder. You can watch the traffic and read the files without me.
>
> It's $39/month (or $468/year) for the Solo plan. The subscription covers ongoing legal-content template updates and security patches. The trial is the full app for 30 days, no card.
>
