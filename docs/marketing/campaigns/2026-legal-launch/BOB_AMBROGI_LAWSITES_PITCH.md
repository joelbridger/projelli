...
> 2. v2.1 is tagged and the pack is available to paying users
> 3. keepance.com/legal/ landing page is live
>
> Do not pitch before those three conditions are met. Bob's readers are practitioners.
> Sending a pitch about attorney-facing tools before an attorney has reviewed them is the
> fastest way to earn a public correction.
>
> **Goal:** A LawSites product review or mention. Not a sponsored post. Not a press release
> pickup. An honest review from someone his audience trusts. If he covers it, one mention
> from Bob is worth more than a month of Reddit posts.

---

## Option A: Email pitch (cold, ~175 words)

**To:** bob@lawsites.com (or via the contact form at lawsites.com)
**Subject:** New local-first AI workspace for attorneys — might be worth a look
...
## Option B: Longer product review pitch (~300 words)

Use this if Bob replies asking for more detail, or as a follow-up after initial contact.
...
If there's still no response after that, drop it. Do not send a third email. LawSites is not worth
damaging the relationship over, and Bob has a long memory for people who are pests.

---

## Notes on Bob's coverage patterns

**What he covers:**
- New legal tech tools, particularly for solo and small-firm practice
- AI-in-legal-tech developments, including practical implications for practitioners
- Privacy and data-security concerns in legal software
- Tools that address a specific practice problem rather than vague productivity claims
- Niche tools with a clear differentiated use case

**What he does not cover:**
- Hype. "Revolutionary" and "game-changing" are filters, not hooks.
- Vaporware. He has covered too many tools that shipped half-baked. The Legal pack needs to be real
  and reviewed before the pitch goes out.
- BigLaw tech or enterprise practice management. That is not his beat.
...
- Do not send a press kit as an attachment to a cold email. If he wants assets, he will ask.

**Finding Bob's contact info:**
- lawsites.com has a contact page
- He is active on LinkedIn and X (@bobambrogi)
- A brief LinkedIn note before the email is acceptable but not required
