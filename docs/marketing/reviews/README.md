...
## Templates
- `TEMPLATE_monthly_review.md`: copy at the start of each monthly review
...
2. Pull the numbers from the data sources listed in section 7 of `strategy/06-measurement-cadence.md`
3. Fill the template
4. Run the review with the schedule from section 3 of the same doc
5. Commit the completed file

## Past reviews
None yet. The first monthly review happens on the first Monday after launch month closes.
