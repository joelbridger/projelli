# Projelli landing page — conversion research brief
...
## Section A — Top 12 conversion principles for Projelli's audience
...
5. **Specificity beats adjectives.** What to do: every benefit on the page should be
   ...
   replace "private" with "files in `~/Documents/Projelli/`". Why: technical buyers
...
6. **Use problem-first storytelling, not feature lists.** What to do: lead each
   ...
   then the mechanism ("Projelli remembers"), then the proof (screenshot). Why:
...
removes a click and pre-qualifies. Better than bare "Download Projelli."
...
## Section C — Most likely conversion killers on Projelli specifically
...
6. **"Free 30-day trial" + "Download Projelli" mismatch.** Reads like
   bait-and-switch. Either rename CTA to "Try Projelli free for 30 days" or
   make the trial mechanic immediately visible.

## Section D — Sources actually fetched

1. https://projelli.com — current page audit
