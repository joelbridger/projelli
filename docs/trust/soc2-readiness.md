...
> **This is a readiness and gap-analysis document. It is NOT a SOC 2 report and Advisor Prep Hero is NOT SOC 2 certified.**
>
...
### Confidentiality: likely in scope (this is Advisor Prep Hero's strongest story)
...
| Disclosure to third parties | BYOK provider is the customer's own processor, not Advisor Prep Hero's; sub-processors are limited and listed. | Privacy-criteria-specific documentation and notice not yet produced. |
...
8. **Honest scoping of residuals** the auditor will see anyway: plaintext workspace files by design, local vector embeddings/metadata for query, and the fact that cloud AI providers see prompts in BYOK mode (this is the customer's processor, not Advisor Prep Hero's, and should be documented as such).
...
*This is a readiness/gap document, not a SOC 2 report. Advisor Prep Hero holds no SOC 2 certification as of this writing. Becoming SOC 2 Type II compliant requires an external CPA auditor and a multi-month observation period that the architecture alone does not satisfy.*
