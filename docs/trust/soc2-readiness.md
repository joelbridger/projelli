...
8. **Honest scoping of residuals** the auditor will see anyway: plaintext workspace files by design, plaintext vector metadata for query, and the fact that cloud AI providers see prompts in BYOK mode (this is the customer's processor, not Advisor Prep Hero's, and should be documented as such).
